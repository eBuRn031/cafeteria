...
Namespace ClaseCodeDOM
    ...
    Public Class Transaccion_pedido
        ...
        Public Overridable Function SP_ventasEdit(ByVal CE_personas As CE_personas, ByVal CE_pedido As CE_pedido, ByVal ListaCE_detallepedido As List(Of CE_detallepedido), ByVal ListaCE_productostock As List(Of CE_productostock)) As Boolean
            Dim dt_personas As New DataTable
            Dim dt_pedido As New DataTable
            ...
            Using Scope As New TransactionScope()
                Using conexion As New MySqlConnection(conexion_base)
                    Try
                        ...
                        CE_pedido.idpersonas = id_personas
                        If CD_pedido.SP_pedido(CE_pedido, conexion) Then boolventas_compras *= 1 Else boolventas_compras *= 0
                        id_pedido = CE_pedido.idpedido
